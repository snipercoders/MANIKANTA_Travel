...
export default function Header() {
  ...
  const handleDesktopTransportMouseEnter = () => {
  ...
  const handleDesktopTransportMouseLeave = () => {
              ...
              if (item.submenu) {
                return (
                  <div 
                    key={item.name} 
                    className="relative"
                    onMouseEnter={handleDesktopTransportMouseEnter}
                    onMouseLeave={handleDesktopTransportMouseLeave}
                  >
                    <a
                      href={item.href}
                      onClick={handleDesktopTransportClick}
                    ...
                    {/* Dropdown */}
                    <div 
                      className={`absolute left-1/2 -translate-x-1/2 mt-2 w-60 rounded-xl shadow-2xl bg-white dark:bg-slate-800 ring-1 ring-gray-200 dark:ring-gray-700 transition-all duration-300 z-50 ${
                        desktopTransportOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
                      }`}
