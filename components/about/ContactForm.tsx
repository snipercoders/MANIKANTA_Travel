...
const ContactForm = () => {
  ...
  const formatWhatsAppMessage = () => {
    ...
    return `*New Booking Request*%0A%0A` +
           ...
           `*Bus Type:* ${busType}%0A` +
           `*Message:* ${message || 'No message provided'}%0A%0A` +
           `_Sent from Manikanta Tours & Travels Website_`;
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-500 text-xs sm:text-sm mt-1">Available 24/7 for emergencies</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-500 text-xs sm:text-sm mt-1">Response within 2 hours</p>
                </div>
              </div>
        ...
        {/* Form Card */}
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg sm:rounded-xl lg:rounded-2xl shadow-lg sm:shadow-xl p-4 sm:p-6 md:p-8 border border-gray-100">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  {/* Bus Type Field */}
                  <div className="space-y-1 sm:space-y-2">
                    <label className="block text-gray-700 font-medium text-sm sm:text-base mb-2">Bus Type</label>
                  ...
                  >
                    {isSubmitting ? (
                      <div className="flex items-center justify-center space-x-2">
                        ...
                        <span className="text-sm sm:text-base">Sending to WhatsApp...</span>
                      </div>
                    ) : (
                      <div className="flex items-center justify-center space-x-2">
                        <FiSend className="text-sm sm:text-base lg:text-lg" />
                        <span className="text-sm sm:text-base">Send Booking Request via WhatsApp</span>
                      </div>
                    )}
                  </button>
                  <p className="text-center text-gray-500 text-xs sm:text-sm mt-2 sm:mt-4 px-2">
                    After submitting, you'll be redirected to WhatsApp to confirm your details
                  </p>
                </div>
              </form>
