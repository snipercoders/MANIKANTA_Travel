    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-gray-50 to-gray-50 border-2 border-gray-200 rounded-2xl p-6">
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-gray-50 to-gray-50 border-2 border-gray-200 rounded-2xl p-6">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="font-bold text-black text-lg mb-3">Advance Payment</h4>
              ...
              <div>
                <h4 className="font-bold text-black text-lg mb-3">Balance Payment</h4>
                <div className="bg-white p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-bold text-black">Processing Time</h4>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between bg-white p-4 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-black">Full Refund</div>
              ...
              <div className="flex items-center justify-between bg-white p-4 rounded-xl">
                <div className="flex items-center gap-3">
                  <Clock className="h-5 w-5 text-gray-700" />
                  <div>
                    <div className="font-bold text-black">Partial Refund</div>
              ...
              <div className="flex items-center justify-between bg-white p-4 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-black">No Refund</div>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-50 border-2 border-gray-200 rounded-2xl p-6">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="text-center sm:text-left">
            <h4 className="font-bold text-black text-lg mb-2">Payment Security</h4>
