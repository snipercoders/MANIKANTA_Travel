...
export default function MyTripSection() {
  return (
    <div className="space-y-10">
      ...
      {/* Journey Timeline */}
      <div className="bg-gradient-to-r from-gray-50 to-gray-50 border-2 border-gray-200 rounded-2xl p-6 sm:p-8">
        ...
        <div className="relative">
          ...
          <div className="space-y-8 pl-12 sm:pl-16">
            {/* Step 1 */}
            <div className="relative">
              <div className="absolute -left-9 sm:-left-12 top-0 w-8 h-8 sm:w-10 sm:h-10 bg-gray-700 rounded-full flex items-center justify-center">
                <span className="text-white font-bold text-sm sm:text-base">1</span>
              </div>
              <div className="bg-white p-5 rounded-xl shadow-sm">
                <h4 className="font-bold text-black text-lg mb-2">Booking Confirmation</h4>
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="bg-gray-100 text-black text-xs font-medium px-3 py-1 rounded-full">Instant</span>
                  <span className="bg-gray-100 text-black text-xs font-medium px-3 py-1 rounded-full">WhatsApp/Email</span>
                </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white p-5 rounded-xl shadow-sm">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-bold text-black text-lg">Pickup Process</h4>
                </div>
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="bg-gray-100 text-black text-xs font-medium px-3 py-1 rounded-full">15 min early</span>
                  <span className="bg-gray-100 text-black text-xs font-medium px-3 py-1 rounded-full">Live tracking</span>
                </div>
                <p className="text-gray-700">
            ...
            <div className="relative">
              ...
              <div className="bg-white p-5 rounded-xl shadow-sm">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-bold text-black text-lg">Onboard Safety</h4>
                </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white p-5 rounded-xl shadow-sm">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-bold text-black text-lg">Support & Assistance</h4>
                </div>
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="bg-gray-100 text-black text-xs font-medium px-3 py-1 rounded-full">24Ã—7</span>
                  <span className="bg-gray-100 text-black text-xs font-medium px-3 py-1 rounded-full">Emergency</span>
                </div>
                <p className="text-gray-700">
      ...
      <div className="bg-gray-50 border-2 border-gray-200 rounded-2xl p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="font-bold text-black text-lg mb-2">Important Trip Notes</h4>
