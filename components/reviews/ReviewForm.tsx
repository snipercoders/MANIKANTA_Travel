    ...
    try {
      ...
      setTimeout(() => {
        setFormData({
          ...
          tourPackageId: '', travelerType: 'Family', monthOfTravel: '',
          tripDuration: '', images: []
        });
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-7">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="ml-6 text-2xl font-bold text-gray-800">{formData.rating}.0</span>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none transition"
              />
            ...
            {/* Tour Package */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">Tour Package (Optional)</label>
              <select
                value={formData.tourPackageId}
                onChange={e => handleInputChange('tourPackageId', e.target.value)}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500"
            ...
            <div>
              ...
              {imagePreviews.length > 0 && (
                <div className="mb-5 grid grid-cols-3 sm:grid-cols-5 gap-3">
                  {imagePreviews.map((src, i) => (
                    <div key={i} className="relative group">
                      <img src={src} alt="preview" className="w-full h-28 object-cover rounded-xl border" />
                      <button
                        type="button"
              ...
              >
                <Upload className="h-10 w-10 mx-auto mb-3 text-red-600" />
            ...
            <button
              type="submit"
              disabled={isSubmitting || uploadingImages}
              className="w-full py-4 bg-gradient-to-r from-red-600 to-red-700 text-white text-lg font-bold rounded-xl hover:from-red-700 hover:to-red-800 disabled:opacity-70 disabled:cursor-not-allowed transition shadow-lg"
            >
