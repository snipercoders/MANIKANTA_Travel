...
export default function ContactMap() {
  return (
    <div className="bg-gradient-to-r from-gray-50 to-gray-50 rounded-lg sm:rounded-2xl shadow-lg sm:shadow-xl overflow-hidden border border-gray-200">
      <div className="p-4 sm:p-6">
        ...
        {/* Business Badge */}
        <div className="bg-white p-3 rounded-lg border border-gray-200 mb-4 sm:mb-6">
          <p className="text-black text-sm sm:text-base font-medium">
            <span className="font-bold">ðŸ“ Office Address:</span> Agara, Kanakapura Main Road, Bangalore â€“ 560082
          </p>
      ...
      {/* Map Placeholder */}
      <div className="relative h-48 sm:h-64 bg-gradient-to-r from-gray-100 to-gray-100">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="relative">
            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-500 rounded-full flex items-center justify-center animate-pulse shadow-lg">
              <div className="w-3 h-3 sm:w-4 sm:h-4 bg-white rounded-full"></div>
            </div>
            <div className="w-1 h-4 sm:h-6 bg-gray-500 mx-auto -mt-1"></div>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6 bg-gray-50">
        <div className="mb-4 sm:mb-6">
          ...
          <div className="bg-white p-3 sm:p-4 rounded-lg sm:rounded-xl border border-gray-200">
            ...
            <div className="flex items-center gap-2 mt-2 sm:mt-3">
              <span className="text-gray-500 text-sm sm:text-base">ðŸ‘‘</span>
        ...
        <div className="mt-4 sm:mt-6">
          <button className="w-full py-2.5 sm:py-3 bg-gradient-to-r from-black to-gray-900 text-white font-medium rounded-lg sm:rounded-xl hover:from-black hover:to-gray-800 transition-all duration-300 flex items-center justify-center space-x-2 text-sm sm:text-base">
            <span>ðŸ—ºï¸</span>
