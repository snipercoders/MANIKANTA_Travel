...
export default function GalleryPage() {
  ...
  const getMockGalleryItems = (): GalleryItem[] => [/* your mock data */];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero - Red Theme */}
      <section className="relative overflow-hidden bg-gradient-to-r from-red-900 via-red-800 to-red-900 text-white pt-20 pb-16 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
            Travel <span className="text-yellow-300">Gallery</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <button
              onClick={() => setShowFilters(!showFilters)}
              className="sm:hidden flex items-center gap-2 px-5 py-3 bg-red-600 text-white rounded-xl font-medium hover:bg-red-700 transition"
            >
          ...
          {showFilters && (
            <div className="sm:hidden bg-white rounded-2xl shadow-lg p-5 border">
              <GalleryFilters
                filters={filters}
                onFilterChange={handleFilterChange}
                allCategories={allCategories}
      ...
      {isDeleteMode && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-red-600 text-white px-6 py-4 rounded-full shadow-2xl flex items-center gap-4 animate-pulse">
          <span className="font-bold text-lg">DELETE MODE ACTIVE</span>
          <button onClick={() => setIsDeleteMode(false)} className="bg-white text-red-600 px-4 py-2 rounded-lg font-medium">
            Exit
          </button>
        </div>
      )}
